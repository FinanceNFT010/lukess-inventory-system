...
## CURRENT BLOCK
- **Block Number:** B12.2.2
- **Block Name:** Demo en Español Neutro (Sincronización de Catálogo Masivo)
- **Status:** DONE
...
- **Block Number:** B12.2.2
- **Block Name:** Demo en Español Neutro
- **Completed:** 2026-03-12
- **Commits:**
  - IS: `feat(demo): B12.2.2 — catalog sync and analytics re-seed in Neutral Spanish` (commit: TBD)

---

### Files Modified
- **IS:** `scripts/seed-demo-analytics-es.mjs` (NEW — complete rewrite of analytics seed script to hit dynamic products in Spanish)
...
- **Total Tables:** 19+
- **Migrations Applied (B12.2.2 wiped previous B12.2.x seed data):**
  - Executed `seed-demo-analytics-es.mjs` which cleared `inventory`, `sales`, `sale_items`, `inventory_transactions`.
  - Re-seeded 108 inventory rows corresponding to 27 active products.
  - Re-seeded 74 POS & Online sales over the last 60 days with realistic LATAM names (e.g., Carlos Mendoza) and mix of QR/Cash/Card payments.
  - Re-seeded 147 sale items and corresponding inventory transactions natively.
- **Demo Auth Users Created (From B12.2.x):**
...
- **Name:** Visual demo polish — consider `/demo` public landing redirect, Vercel domain aliasing `inventory.adrianoliver.dev`
...
|---|---|---|---|---|
| B12.2.2 | Demo en Español Neutro | ✅ DONE | 2026-03-12 | TBD |
| B12.2.x | Demo Premium Transformation | ✅ DONE | 2026-03-12 | 0b001af |
...
## CURRENT BLOCK
- **Block Number:** 20-Portfolio
- **Block Name:** Open-Source Portfolio Demo Prep
- **Status:** DONE
...
- **Completed:** 2026-03-10
- **Commits:**
  - LE: `chore: scrub personal data and enforce strict minimalist branding guidelines` (lukess-landing-ecommerce)

---

### Files Modified
- **LE:** `app/globals.css` (MODIFIED — enforce strict grayscale + gold palette)
- **LE:** `components/ui/Card.tsx` (MODIFIED — standardized shadow borders)
- **LE:** `components/cart/CartDrawer.tsx` (MODIFIED — UI standardization sweep)
- **LE:** `components/cart/CheckoutModal.tsx` (MODIFIED — UI standardization sweep)
